...
%>	   
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
		...
		<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="pds_view.jsp?idx=<%= dto.getIdx() %>"><%= dto.getSubject() %></a></font></td>
...
%>	  
   ...
   <tr>
      <td colspan="7" align="right">
		<a href="pds_write.jsp"><img src="./img/write.gif" alt="자료등록" align="middle" border="0"></a>
      &nbsp;
	  </td>
   </tr>
