    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <c:if test="${!empty list}">
	      ...
	      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
	          ...
	          <td align="left" height="20"><font face="돋움" size="2" color="#000000"><a href="/guest?cmd=guest_view&idx=${i.idx}&page=${page}">${i.subject}</a></td>
     ...
     <div align="center">
		...
		<tr>
			...
			<a href="/guest?cmd=guest_write"><img src="/Guest/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
