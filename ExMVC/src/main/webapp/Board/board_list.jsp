...
<%@ page import="java.util.*, com.jslhrd.exmvc.model.board.*" %>
  ...
  <tr>
		...
		<c:forEach var="i" items="${list}">
			<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
				...
				<td align="left" height="20">&nbsp;
					...
					<a class="list" href="/board?cmd=board_view&idx=${i.idx}&page=${page}">${i.subject}</a></font></td>
	...
	<table width="600">
		<tr>
			...
			<form action="board?cmd=board_list" method="post" name="board">	
				<table>
			...
			<a href="/board?cmd=board_list"><img src="Board/img/list-2.gif" alt="자료등록" align="middle" border="0"></a>&nbsp;&nbsp;&nbsp;
			<a href="/board?cmd=board_write"><img src="Board/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
